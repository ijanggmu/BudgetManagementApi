...
public class PolicyCalculatorService(ICoreApiService coreApiService) : IPolicyCalculatorService
{
    public async Task<Result<PremiumCalculationResponseModel>> CalculatePremiumAsync(PremiumCalculateRequestModel requestModel)
    {
        ...
        else if (requestModel.InsuranceType == InsuranceType.InternationalTravel)
        {
            ...
            if (regionHelperResponse.IsSuccess)
                ...
                return Result<PremiumCalculationResponseModel>.Failed(regionHelperResponse.Error);
        ...
        return Result<PremiumCalculationResponseModel>.Success(result);
