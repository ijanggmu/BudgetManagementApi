        ...
        BSCalendar = new Dictionary<int, int[]>
            {
                ...
                { 81, new int[] { 2081, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31 } },
                { 82, new int[] { 2082, 31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30 } },
                ...
                { 99, new int[] { 2099, 31, 31, 32, 31, 31, 31, 30, 29, 29, 30, 30, 30 } }
            };
    }
}
interface ICalendar
