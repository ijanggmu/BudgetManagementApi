...
namespace Data.Migrations.Core
{
    ...
    [Migration("20250707125237_DIANumber, PartyId and PartyCode added to customer")]
    partial class DIANumberPartyIdandPartyCodeaddedtocustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.Payment.PaymentTransaction", b =>
                {
                    ...
                    b.Property<string>("PolicyDraftId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Data.Entities.Payment.PaymentTransaction", b =>
                {
                    b.HasOne("Data.Entities.Draft.PolicyDraft", "PolicyDraft")
                        .WithMany()
                        .HasForeignKey("PolicyDraftId")
                        .OnDelete(DeleteBehavior.Restrict);
