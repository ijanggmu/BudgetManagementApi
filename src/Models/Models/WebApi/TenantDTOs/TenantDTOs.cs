...
public record CreateQuotationDto(string LeadId, Guid ProductId, Guid ProspectId,DateOnly? ValidUntil, bool? IsDirectBusiness, PremiumCalculateRequestModel PremiumRequestModel, IEnumerable<QuotationItemDto> Items);
