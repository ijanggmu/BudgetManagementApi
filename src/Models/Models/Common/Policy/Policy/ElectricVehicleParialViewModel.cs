...
{
    public class ElectricVehicleParialViewModel
    {
        ...
        [Required(ErrorMessage = "Please enter the KiloWatt of vehicle")]
        ...
        public string AuthorizedServiceCenter { get; set; }
        public List<WarrantyPeriodEV> WarrantyPeriodList { get; set; }
    }

    public class WarrantyPeriodEV
    {
        public string WarrantyContent { get; set; }
        public string WarrantyPeriod { get; set; }
        public string ExtendedWarrantyPeriod { get; set; }
