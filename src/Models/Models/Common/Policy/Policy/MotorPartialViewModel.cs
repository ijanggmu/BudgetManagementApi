...
{
    public class MotorPartialViewModel
    {
        ...
        //public bool IsPaToRiderAndOnePillionRider { get; set; }
        public string PartyId { get; set; }
        public string PortfolioId { get; set; }
        [Required(ErrorMessage = "Please enter the type of motorcycle")]
        ...
        //[Required(ErrorMessage = "Please enter the date you registered the vehicle")]
        [RequiredIf("PurchasedNewOld", true, ErrorMessage = "DateOfPurchase is required.")]
        ...
        public string ProposerName { get; set; }  // ProposerName

        public RiskEnum[] TypeOfInsurance { get; set; }
        [Required(ErrorMessage = "Please enter the cubic capacity of motorcycle")]
