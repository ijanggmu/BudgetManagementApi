...
public enum TankerConfigType
{
    ...
    [Display(Name = "Govt. Per Goods Carrying Capacity in tons")]
    ...
    [Display(Name = "Govt. RSMDT Sum Insured Amount For Paid Driver")]
    GovtRSMDTSumInsuredAmountForPaidDriver = 44,

    [Display(Name = "Govt. RSMDT Sum Insured Amount For Helper")]
    GovtRSMDTSumInsuredAmountForHelper = 45,

    [Display(Name = "Govt. RSMDT Sum Insured Amount For Passengers")]
